...
// *** ANALOG GÝRÝÞLER **
// ANALOG GÝRÝÞ 1 - PA03 - 42 AIN1
// ANALOG GÝRÝÞ 2 - PA02 - 14 AIN0
// ANALOG GÝRÝÞ 3 - PB08 - 15 AIN2
// ANALOG GÝRÝÞ 4 - PB09 - 16 AIN3
// ANALOG GÝRÝÞ 5 - PA04 - 17 AIN4
	//PWM1 -  PA13	-	38
	//PWM2 -  PA20	-	6
	//PWM3 -  PA23	-	21
	//PWM4 -  PA22	-	20
...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTA,  8, PIO_TIMER, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM0_CH0, TCC0_CH0, EXTERNAL_INT_NMI },  // TCC0/WO[0]// DIGITAL OUTPUT 0-32V SEÇME - PA09	-	4
  ...
  { PORTA, 21, PIO_TIMER_ALT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT), No_ADC_Channel, PWM0_CH7, TCC0_CH7, EXTERNAL_INT_5 }, // TCC0/WO[7] DIGITAL OUTPUT 0-32V SEÇME - PA21	-	39

  // Digital High
  { PORTA,  6, PIO_TIMER, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM1_CH0, TCC1_CH0, EXTERNAL_INT_6 }, // TCC1/WO[0] // DIGITAL OUTPUT 0-32V SEÇME - PA06	-	8
  { PORTA,  7, PIO_TIMER, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM1_CH1, TCC1_CH1, EXTERNAL_INT_7 }, // TCC1/WO[1] // DIGITAL OUTPUT 0-32V SEÇME - PA07	-	9
 ...
 // { PORTA,  5, PIO_ANALOG, 0, ADC_Channel5, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_5 }, // ADC/AIN[5]
  ...
  { PORTB,  2, PIO_OUTPUT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // ADC/AIN[10] // K15 ÇIKIÞI			-  PB02 -   19
 ...
 // { PORTA, 23, PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7 }, // SCL: SERCOM3/PAD[1]
  ...
  { PORTA, 27, PIO_OUTPUT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // DIGITAL OUTPUT 4-20mA SEÇME -  PA27	-	26
  ...
  { PORTA, 24, PIO_OUTPUT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // DIGITAL OUTPUT 0-32V SEÇME (VEYA REZÝSTÝF)- PA24 -	28
  { PORTA, 25, PIO_OUTPUT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // DIGITAL OUTPUT 4-20mA SEÇME -  PA25	-	29
  ...
  // { PORTB, 23, PIO_SERCOM_ALT, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // RX: SERCOM5/PAD[3]
	    { PORTB, 22, PIO_OUTPUT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, //  DIGITAL OUTPUT 4-20mA SEÇME
	    { PORTB, 23, PIO_OUTPUT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, //  DIGITAL OUTPUT 4-20mA SEÇME
