...
#ifndef EF_Standart_Library_H
#define EF_Standart_Library_H
#include "Arduino.h"
...
//!Upward counter
/*!
    If CTU::RESET is true the counter value CTU::CV is initialised by 0_ If there
...
/*!
    ...
    CTD::CV is decreased by one as long as CTD::CV is bigger than 0_
    The output variable CTD::Q is set to true if CTD::CV is equal to 0_
...
/*!
    If CTUD::RESET is true the counter variable CTUD::CV is initialised with 0_
    ...
    is decreased by 1 as long as it is greater then 0_

    CTUD::QU becomes true if the counter variable CTUD::CV is greater then or
    equal to the upper limit CTUD::PV.
    CTUD::QD becomes true if the counter variable CTUD::CV is 0_
